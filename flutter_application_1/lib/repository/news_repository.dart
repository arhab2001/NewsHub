...
class NewsRepository {
  Future<CategoriesNewsModel> fetchNewsCategoires(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=6dbcf61ff79047c8919eedd3f1c897c3';
  ...
  Future<NewsChannelsHeadlinesModel> fetchNewsChannelHeadlinesApi(
    ...
    String newsUrl =
        'https://newsapi.org/v2/top-headlines?sources=${newsChannel}&apiKey=6dbcf61ff79047c8919eedd3f1c897c3';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
